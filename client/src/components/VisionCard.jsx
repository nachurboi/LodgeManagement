   ...
   <div className='mt-5'>
     <div className="card m-auto bg-info grow " style={{width: '18rem'}}>
        <div className="card-body text-center">
          <h5 className="card-title text-white border-bottom border-dark pb-3">MISSION</h5>
          ...
          <h5 className="card-title text-white  border-bottom border-dark pb-3">VISION</h5>
