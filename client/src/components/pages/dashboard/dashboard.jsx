   ...
   <div>
      <div className=' container-fluid vh-75 '>
        <div className='row '>
          ...
          <div className='col-xs-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 text-center'><div className='text-center bg-light  vh-75' style={{overflow:'scroll'}}><GalleryCard /></div>
          </div>
        </div>
      </div>  
  </div>
